...
func _run() -> void:
	...
	_label("Enemy art pass — idle and four walk frames", Vector2(160, 25), 1600, 38)
	...
	if "--screenshot" in OS.get_cmdline_user_args():
		...
		_check(output.save_png("res://.scratch/enemy-art-pass/walk-preview.png") == OK, "Preview saved")
