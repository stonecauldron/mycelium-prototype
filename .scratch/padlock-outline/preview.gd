...
const HERE := "res://.scratch/padlock-outline/"
...
func _run() -> void:
	...
	_label("Padlock outline refinement", Vector2(0, 32), 1920, 52, Color("293c39"))
	_label("Slightly heavier ink · same icon bounds and UI sizes", Vector2(0, 108), 1920, 28, Color("67705a"))
