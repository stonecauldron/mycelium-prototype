...
Starter confirmation uses this option to suppress the generic click and plays
the same `SEAL` confirmation cue as choosing a Seal when its units are granted.
